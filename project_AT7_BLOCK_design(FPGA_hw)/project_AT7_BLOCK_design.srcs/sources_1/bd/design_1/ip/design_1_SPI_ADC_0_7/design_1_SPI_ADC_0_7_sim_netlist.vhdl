...
--               /home/nks/Desktop/at7_ex16_bd/project_AT7_BLOCK_design/project_AT7_BLOCK_design.srcs/sources_1/bd/design_1/ip/design_1_SPI_ADC_0_7/design_1_SPI_ADC_0_7_sim_netlist.vhdl
-- Design      : design_1_SPI_ADC_0_7
...
entity design_1_SPI_ADC_0_7_SPI_ADC is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_SPI_ADC_0_7_SPI_ADC : entity is "SPI_ADC";
end design_1_SPI_ADC_0_7_SPI_ADC;

architecture STRUCTURE of design_1_SPI_ADC_0_7_SPI_ADC is
  ...
  signal \fifo_write_ready0__0\ : STD_LOGIC;
  signal fifo_write_ready_i_1_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 7 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \cnv_cnt[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cnv_cnt[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cnv_cnt[2]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \data_cnt[4]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of fifo_write_ready0 : label is "soft_lutpair1";
begin
  ADC_ncs <= \^adc_ncs\;
...
fifo_write_ready0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000010"
    )
        port map (
      ...
      I3 => cnv_cnt(3),
      I4 => cnv_cnt(0),
      O => \fifo_write_ready0__0\
    );
fifo_write_ready_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
      I0 => \fifo_write_ready0__0\,
      I1 => RESET,
      I2 => \^fifo_write_ready\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_SPI_ADC_0_7 is
  port (
  ...
  attribute NotValidForBitStream of design_1_SPI_ADC_0_7 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_SPI_ADC_0_7 : entity is "design_1_SPI_ADC_0_7,SPI_ADC,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_SPI_ADC_0_7 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_SPI_ADC_0_7 : entity is "SPI_ADC,Vivado 2018.1";
end design_1_SPI_ADC_0_7;

architecture STRUCTURE of design_1_SPI_ADC_0_7 is
  signal \^clk\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of ADC_clk : signal is "xilinx.com:signal:clock:1.0 ADC_clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of ADC_clk : signal is "XIL_INTERFACENAME ADC_clk, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN design_1_SPI_ADC_0_7_ADC_clk";
...
begin
  ADC_clk <= \^clk\;
  \^clk\ <= clk;
inst: entity work.design_1_SPI_ADC_0_7_SPI_ADC
     port map (
      ADC_ncs => ADC_ncs,
      ADC_sda => ADC_sda,
      RESET => RESET,
