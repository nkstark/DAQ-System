...
HD_PWD='/home/nks/Desktop/at7_ex16_bd/project_AT7_BLOCK_design/project_AT7_BLOCK_design.runs/design_1_FIFO_RD_Mux_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FIFO_RD_Mux_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FIFO_RD_Mux_0_1.tcl
